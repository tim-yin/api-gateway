package com.fly.app.gateway.controller;
...
import com.fly.app.gateway.metrics.RestApiTimerManager;
			...
			registerService
					.register(
							...
							new UniqueServiceDefined(
									"",
									"com.fly.fortune.endpoint.MockAggregationServiceApi",
									"1.0",
									"createRecord",
									"com.fly.fortune.endpoint.impl.Product",
									""));
